...
class CarbonDioxideModel:
    def __init__(
        ...
        self.total_moles = (reactor.P_tot*self.gas_volume)/((self.reactor.T_set+273.15)*R)
    ...
    def update_gas_transfer_speed(self)->None:
        ...
        self.gas_transfer_speed_value = (
            self.fizz_velocity_constant_value*self.batch.liquid_volume*(
                self.carbon_dioxide_liquid_molarity-(
                    self.henrys_constant*self.yco2
                )
            )
            )
    ...
    def mass_to_mass_fraction(self, mass_of_specific_solvant, total_solvent_mass)->float:
    ...
    def update_glucose_molarity(self)->None:
        ...
        self.glucose_molarity = self.mass_concentration_to_molarity(self.sugar_concentration, chemicals["glucose"]["molar_mass"])
    ...
    def update_kH(self)->None:
        ...
        self.henrys_constant = henrys_law.kH_final(self.reactor.T_set, self.glucose_molarity, self.w_water, self.w_ethanol)
